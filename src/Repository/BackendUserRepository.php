...
/**
 * @extends ServiceEntityRepository<BackendUser>
 *
...
class BackendUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(BackendUser $entity, bool $flush = false): void
    {
    ...
    public function remove(BackendUser $entity, bool $flush = false): void
    {
